...
static const uint32_t kChunkSize = 1024u * 4;
...
// |    size   |   allocated-bit   |
// |    29     |         3         |
static inline uint32_t is_allocated(const char *header);
static inline uint32_t get_size(const char *header);
static inline uint32_t get_footer_content(const char *header);
static inline uint32_t *get_footer(const char *header);
static inline void set_header(char *header, const size_t size, const size_t is_allocated);
static inline void set_footer(char *header, const size_t size, const size_t is_allocated);
static inline char *next(const char *header);
static inline char *prev(const char *header);
static inline int is_end(const char *header);
static inline void erase_header(char *header);
static inline void collapse(char *header);
...
static inline void address_assert(void *header)
{
